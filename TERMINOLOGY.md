# Strands Builder — Terminology & Concepts

A reference guide for all terms, node types, and patterns used in Strands Builder. Each entry maps directly to the [Strands Agents SDK documentation](https://strandsagents.com/).
